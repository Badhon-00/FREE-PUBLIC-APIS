...
| [Goalise Football Data](https://goalise.com) | Real-time football data including scores, fixtures, standings, players, teams, transfers, and news | `apiKey` | Yes | Unknown |
