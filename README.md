...
| [IqbalAPI](https://iqbal-api-docs.up.railway.app) | Allama Iqbal's Urdu poetry with English translations, full-text search, and random verse endpoints | No | Yes | Yes |
