...
API | Description | Auth | HTTPS | CORS |
|:---|:---|:---|:---|:---|
| [Appcircle](https://api.appcircle.io/openapi) | A Mobile CI/CD platform with testing and store deployment for fully automated mobile app releases | `apiKey` | Yes | Unknown |
