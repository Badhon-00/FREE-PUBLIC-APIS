...
| [Mood Metrics](https://mood-metrics-api.dev) | Multilingual text sentiment analysis with overall sentiment score and per-primary-emotion breakdowns | `apiKey` | Yes | Yes 
