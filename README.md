...
API | Description | Auth | HTTPS | CORS |
|:---|:---|:---|:---|:---|
| [OBEDIENCE AI Text API](https://theoxicew-obedience-text-api.hf.space) | Summarize, sentiment, keywords, translate and clean text using Llama 3.3 70B | No | Yes | Unknown |
