...
| [CalcFi](https://calcfi.app/api/insights/openapi.json) | Anonymous personal-finance aggregates: housing-cost burden, calc-run patterns, Reality Score distribution by US city/state. K-anonymous (count >= 10), CC-BY-4.0 | No | Yes | Yes | |
