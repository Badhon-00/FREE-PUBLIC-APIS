...
| [Jenkins API](https://pypi.org/project/jenkinsapi/) | Jenkins provides an API to manage jobs, builds, and plugins programmatically. | Auth (yes) | HTTPS (yes) | CORS (unknown) |
