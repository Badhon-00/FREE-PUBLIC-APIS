...
| [SnapAPI](https://snapapi-production-3fa2.up.railway.app/docs) | Developer utility API — QR codes, screenshots, image resize, hashing, UUIDs, PDFs and more | `apiKey` | Yes | Yes |
