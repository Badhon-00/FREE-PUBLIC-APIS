...
| [FinancialData.Net](https://financialdata.net/documentation) | Stock data, financial statements, insider trades, ETFs, indices, derivatives, OTC and crypto. | `apiKey` | Yes | Unknown | |
