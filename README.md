...
| [IteraTools](https://api.iteratools.com) | Multi-tool API for AI agents: image generation, OCR, TTS, scraping, QR codes, weather, crypto, PDF and more | `apiKey` | Yes | Yes |
