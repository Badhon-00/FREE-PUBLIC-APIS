...
| [NOAA Climate Data Online](https://www.ncdc.noaa.gov/cdo-web/webservices/v2) | Historical and current climate data including daily summaries, precipitation, and storm events | `apiKey` | Yes | Unknown |
