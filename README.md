...
| [Human Design Hub](https://api.humandesignhub.app/docs) | Human Design chart calculation API with bodygraph, transit, composite, and penta analysis | `apiKey` | Yes | Yes |
