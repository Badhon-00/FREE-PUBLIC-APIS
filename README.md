...
| [CORS Proxy](https://rapidapi.com/joshirajesh448-emyeudCJ4Y-/api/cors-proxy1) | Get around the dreaded CORS error by using this proxy as a middle man | `X-RapidAPI-Key` | Yes | Yes |
