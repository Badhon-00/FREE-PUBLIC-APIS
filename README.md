...
| [Reconmap](https://github.com/reconmap/rest-api) | Reconmap APIS for VAPT (vulnerability assessment and penetration testing) automation and reporting | `OAuth` | Yes | Unknown |
