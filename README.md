...
| [AI Engine Face Analyzer](https://ai-engine.net/apis/face-analyzer) | Face detection, comparison, age/gender/emotion analysis, and celebrity recognition | `apiKey` | Yes | Yes |
