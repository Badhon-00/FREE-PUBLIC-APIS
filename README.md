...
| [Meteomatics Weather API](https://www.meteomatics.com/en/weather-api/) | High-resolution weather data in real time with over 1800 parameters. | `apiKey` | Yes | Yes | Yes |
