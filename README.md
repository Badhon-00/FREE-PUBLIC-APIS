...
| [Oxford](https://developer.oxforddictionaries.com/) | Dictionary data including definitions, pronunciations, and examples from Oxford Dictionaries | `apiKey` | Yes | No |
