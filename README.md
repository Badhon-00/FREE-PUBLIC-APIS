...
| [FBR-API](https://fbrapi.com/documentation) | Premier source for complete football stats, offering detailed info on leagues, teams & players worldwide | `apiKey` | Yes | Yes |
