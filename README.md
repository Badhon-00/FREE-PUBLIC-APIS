...
| [Smidyo Laser-Shop Pricing API](https://smidyo.com/laser-shop-pricing-api) | An API for instant time estimation & pricing of laser cutting & engraving | `apiKey` | Yes | No |
