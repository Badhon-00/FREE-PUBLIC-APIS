...
| [QR Code - Dynamic and Static](https://updeploy.stoplight.io/docs/qr-code-dynamic-and-static) | This API is focused on generating and storing dynamic and static QR Codes that can be edited | `apiKey` | Yes | Yes |
